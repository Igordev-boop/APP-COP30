      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput style={styles.input}
            placeholder="Usuário" placeholderTextColor="#ccc"
      ...
      <View style={{ padding: 20 }}>
        ...
        {recipe.id === 1 && (
          <View style={{
            ...
            overflow: 'hidden', // <--- Essencial para que o borderRadius funcione em conteúdo filho como o vídeo
          }}>
          ...
          <Text style={[dynamicStyles.bodyText, {marginTop: 10, marginBottom: 10,fontSize: 22,fontWeight: 'bold', color: dynamicStyles.text.color }]}>
           ...
           {recipe.id === 1 && ( // Condição para mostrar o mapa, se desejar
        <MapComponent /> 
      )}
      </View>
    </ScrollView>
